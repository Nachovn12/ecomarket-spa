...
class KpiServiceTest {
    ...
    void listarKPIs_retornaListaDelRepositorio() {
        IndicadorKPI k1 = buildKpi(1L, TipoKPI.VENTAS_TOTALES, 50000.0);
        IndicadorKPI k2 = buildKpi(2L, TipoKPI.STOCK_BAJO, 5.0);
    ...
    void obtenerKPIPorId_conIdValido_retornaKPI() {
        IndicadorKPI kpi = buildKpi(1L, TipoKPI.RENDIMIENTO_TIENDA, 0.85);
        ...
        assertThat(result.getValor()).isEqualTo(0.85);
    }
    ...
    void listarKPIsPorTipo_retornaListaFiltrada() {
        IndicadorKPI k1 = buildKpi(1L, TipoKPI.VENTAS_TOTALES, 10000.0);
        IndicadorKPI k2 = buildKpi(2L, TipoKPI.VENTAS_TOTALES, 20000.0);
    ...
    void toDTO_mapeaTodosLosCamposCorrectamente() {
        ...
        IndicadorKPI kpi = buildKpi(7L, TipoKPI.ROTACION_INVENTARIO, 3.5);
        kpi.setDescripcion("Rotacion mensual");
        ...
        assertThat(dto.getValor()).isEqualTo(3.5);
        assertThat(dto.getDescripcion()).isEqualTo("Rotacion mensual");
