...
class PedidosClientServiceTest {
    ...
    void ping_respondeOk_retornaMapa() {
        ...
        Map<String, Object> resultado = pedidosClientService.ping();
    ...
    void ping_ResourceAccessException_lanzaIllegalStateException() {
        ...
        IllegalStateException ex = assertThrows(IllegalStateException.class, () -> pedidosClientService.ping());
